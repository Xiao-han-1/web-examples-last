    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 about-info2">
            ...
            <ul>
                ...
                <li><a href="/z?id=${id}&username=${username}" style="color: black">增加新闻</a>
                <a href="/s?id=${id}&username=${username}" style="color: black"> 删除新闻</a>
                <a href="/g?id=${id}&username=${username}" style="color: black"> 修改新闻</a>
                <a href="/c?id=${id}&username=${username}" style="color: black"> 查询新闻</a></li>
            </ul>
        </div>
        <div class="clearfix"></div>
    </div>
